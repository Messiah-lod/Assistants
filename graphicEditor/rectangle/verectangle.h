...
public:
    ...
    enum CornerFlags {//флаги для изменения
        Top = 0x01,
        Bottom = 0x02,
        Left = 0x04,
        Right = 0x08,
...
private:
    ...
    QPointF m_previousPosition;//начальная точка отсчета
    bool m_leftMouseButtonPressed;//нажата ЛКМ
    DotSignal *cornerGrabber[8];//сигнальные точки для для действия с фигурами
