...
TreeModel::TreeModel(const QStringList &headers, const QString &data, QObject *parent)
 ...
 rootData << tr("Name data base") << tr("Path data base"); //В модели будет 2 столбца
...
//int TreeModel::childCount(const QModelIndex & parent)
//{
//	TreeItem *parentItem = getItem(parent);
//	return parentItem->childCount();
//}
...
void TreeModel::OnDoubleClicked(const QModelIndex & index)
{
...
void TreeModel::OnClicked(const QModelIndex & index)
{
	//const QString a = (index.model()->data(index.model()->index(index.row(), index.column())).toString());
